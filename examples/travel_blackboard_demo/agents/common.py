...
def register_travel_tools() -> None:
    tool_builders = {
        TravelFlightTool.type: lambda _cfg, _deps: TravelFlightTool(),
        TravelHotelTool.type: lambda _cfg, _deps: TravelHotelTool(),
        TravelCarTool.type: lambda _cfg, _deps: TravelCarTool(),
        TravelBookingTool.type: lambda _cfg, _deps: TravelBookingTool(),
    }
