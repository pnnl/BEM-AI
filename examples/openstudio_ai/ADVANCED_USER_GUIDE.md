...
- `examples/openstudio_ai/measures/`
...
- `examples/openstudio_ai/policy/measure_registry.yaml`

Add an entry:

- `measure_id`
- `entrypoint` (relative to `examples/openstudio_ai/`)
- `description`
- `allowed`
- `timeout_seconds`
...
- `examples/openstudio_ai/policy/tool_allowlist.yaml`
...
- `examples/openstudio_ai/policy/run_gates.yaml`
...
- `examples/openstudio_ai/skills/hvac_sizing_assistant.md`
...
```python
# examples/openstudio_ai/measures/my_measure.py
import json
import os
import sys
import openstudio
