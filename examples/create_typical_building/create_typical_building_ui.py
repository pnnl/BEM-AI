...
def main():
    st.set_page_config(
        page_title="Create Typical Building AI Chat",
        page_icon="🏗️",
        layout="centered"
    )
    st.title("🏗️ Create Typical Building AI Chat Interface")
    st.caption(
        "Create building geometry models with ASHRAE-compliant construction sets"
    )
